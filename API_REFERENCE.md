...
- **Parameters:**
  - `animation_data_or_path`: The path to the animation JSON file or a table with animation data. Example: `/animations/my_gui_animation.json`.
...
- **Parameters:**
  - `animation_data_or_path`: The path to the animation JSON file or a table with animation data. Example: `/animations/my_animation.json`.
